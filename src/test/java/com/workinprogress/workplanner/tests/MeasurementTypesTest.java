...
public class MeasurementTypesTest {
	...
	public void testSavemeasurementType()
	{
		...
		Long lastInsertId = measurementTypeService.saveMeasurementType(measurementType);
		System.out.println("New measurementType saved whith id:"+lastInsertId);
	}
}
